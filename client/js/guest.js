...
var main = function (mealObjects) {
	...
	tabs.push({
		...
		"content": function(callback) {
			var arr = [];
			var $content = $("<ul>");
			// сначала проходимся по всем меню и заносим их в массив
			...
			// проходимся по всем блюдам и сопоставляем их меню, в котором они нахоятся
